...
Module Module1
    Public Conn As New SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\PartyData.mdf;Integrated Security=True;User Instance=True")
    Public SqlStr, q1Var, q2Var, uNameVar, appNameVar As String
    Public colVar, rowVar, I, J, appNoVar As Long
