...
Public Class CustEventListForm
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim adp As New SqlDataAdapter("Select * From VenueTab  order by Venuecode", Conn)
        adp.Fill(DS1)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        YPos += 100
        XPos = 10
        e.Graphics.DrawString("Venue List Report", MyFont, Brushes.Black, XPos, YPos)
        YPos += 50
        XPos = 10
        'MyFont = New Font("Arial", 12)
        'e.Graphics.DrawString("Venue code", MyFont, Brushes.Black, XPos, YPos)
        'XPos = XPos + 150
