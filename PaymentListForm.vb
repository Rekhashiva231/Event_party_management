...
Public Class PaymentListForm
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim adp As New SqlDataAdapter("Select * From PaymentTab  order by TranNo", Conn)
        adp.Fill(DS1)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        XPos = 10
        e.Graphics.DrawString("Wedding Planner Administration", MyFont, Brushes.Black, XPos, YPos)
        YPos += 50
        ...
        XPos = 10
        MyFont = New Font("Arial", 12)
        e.Graphics.DrawString("TranNo", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
        e.Graphics.DrawString("Date", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
        e.Graphics.DrawString("EventCode", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
        e.Graphics.DrawString("Amt", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
