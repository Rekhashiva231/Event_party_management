...
Public Class EnrollerListReport
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim adp As New SqlDataAdapter("Select enrollerNo,enrollerName,PhoneNo,eMail,qualification From enrollerTab  order by enrollerNo", Conn)
        adp.Fill(DS1)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        XPos = 10
        e.Graphics.DrawString("UID Card Administration", MyFont, Brushes.Black, XPos, YPos)
        YPos += 50
        MyFont = New Font("Arial", 12)
        e.Graphics.DrawString("No. 101, 4th floor, UB City, Bangalore - 560001", MyFont, Brushes.Black, XPos, YPos)
        YPos += 100
        XPos = 10
        e.Graphics.DrawString("Enroller List Report", MyFont, Brushes.Black, XPos, YPos)
        YPos += 50
        XPos = 10
        MyFont = New Font("Arial", 12)
        e.Graphics.DrawString("enrollerNo", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
